    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <form action="daftar-notaPengadaan?menu=Pengadaan" method="POST">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Nomor Pengadaan : <?=$noPengadaan;?></h1>
            <button type="button" class="btn btn-sm btn-primary" onclick="window.location.assign('daftar-notaPengadaan1.php?menu=notaPengadaan')">Kembali</button>
          </div>
          <!-- Content Row -->
