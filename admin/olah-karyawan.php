...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <button class="d-none d-sm-inline-block btn btn-sm btn-primary" data-toggle="modal" data-target="#modalTambahKaryawan">Tambah Karyawan</button>
          </div>
          <!-- Content Row -->
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="datatable-buttons" width="100%" cellspacing="0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?=$i;?></td>
                          <td><?=$res['id_pengguna'];?></td>
                          <td><?=$res['nama_pengguna'];?></td>
                          <td><?=$res['username'];?></td>
                          <td><?=$res['alamat'];?></td>
                          <td><?=$res['telp'];?></td>
                          <td><?=$res['jk'];?></td>
                          <td><button class="btn btn-sm btn-warning" data-toggle="modal" data-target="#myModal" data-id="<?=$res['id_barang'];?>">Edit</button> | <button class="btn btn-sm btn-danger" onclick="hapusBarang('<?=$res['id_barang'];?>')">Hapus</button> </td>
                        </tr>
                        <?php
                        $i++;
                        }
      ...
      <div class="modal fade" id="modalTambahKaryawan" role="dialog">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
  ...
  <script type="text/javascript">
    ...
    function hapusBarang(id){
      alertify.confirm('Perhatian', 'Anda Yakin Akan Menghapus '+id, function(){ window.location.assign('hapus-karyawan?id='+id) }
