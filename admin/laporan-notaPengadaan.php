    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Laporan Pengajuan Barang</h1>
          <!-- Content Row -->
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="card text-center">
                    <div class="card-body">
                      <center>
                        <form action="cetak-pengadaan.php" target="_blank" method="post">
                          <label>Tanggal Awal</label>
                          <input type="date" name="tgl1" class="form-control  mb-4" >
                          <label>Tanggal Akhir</label>
                          <input type="date" name="tgl2" class="form-control  mb-4" >
                          <button class="btn btn-primary" type="submit" name="tampilkan">Proses Laporan</button>
                        </form>
                      </center>
                    </div>
                  </div>                
