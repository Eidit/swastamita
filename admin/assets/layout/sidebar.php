...
?>
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item <?=$statusPengadaan;?> <?=$statusNotaPengadaan;?> <?=$statuslaporanPengadaan;?>">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePengadaan" aria-expanded="true" aria-controls="collapsePengadaan">
          ...
          <span class="text-light">Pengajuan Barang</span>
        </a>
        <div id="collapsePengadaan" class="<?=$showPengadaan;?>" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item <?=$statusPengadaan;?>" href="daftar-pengadaan.php?menu=Pengadaan">Daftar Pengajuan</a>
            <a class="collapse-item <?=$statusNotaPengadaan;?>" href="daftar-notaPengadaan.php?menu=notaPengadaan">Daftar Nota Pengajuan</a>
            <a class="collapse-item <?=$statuslaporanPengadaan;?>" href="laporan-notaPengadaan.php?menu=laporanPengadaan">Laporan Pengajuan</a>
          </div>
        </div>
      </li>
