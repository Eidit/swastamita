      ...
      <li class="nav-item <?=$statusPengadaan;?> <?=$statuslaporanPengadaan;?>">
        ...
        <div id="collapsePengadaan" class="<?=$showPengadaan;?>" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item <?=$statusNotaPengadaan;?>" href="daftar-notaPengadaan1.php?menu=notaPengadaan">Daftar Nota Pengadaan</a>
            <a class="collapse-item <?=$statuslaporanPengadaan;?>" href="laporan-notaPengadaan.php?menu=notaPengadaan">Laporan Pengadaan</a>
          </div>
        </div>
      </li>
