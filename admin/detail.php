      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
           ...
           <!-- <a href="laporan-unit-pengembalian.php?no_transaksi=$no_transaksi" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Buat Laporan</a>-->
            <button type="button" class="btn btn-sm btn-primary" onclick="window.location.assign('index.php?menu=dashboard')">Kembali</button>
          </div>
          <!-- Content Row -->
