...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <table class="table table-bordered table-hover" id="datatable-buttons" width="100%" cellspacing="0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?=$res['qty'];?></td>
                          <td><button class="btn btn-sm btn-danger" onclick="hapusBarang('<?=$res['id_barang'];?>')">Hapus</button> | <button class="btn btn-sm btn-warning" data-toggle="modal" data-target="#myModal" data-id="<?=$res['id_barang'];?>">Edit</button><hr><button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#Unit" data-id="<?=$res['id_barang'];?>">Tambah Unit</button></td>
                        </tr>
                        <?php
                        $i++;
                        }
      ...
      <div class="modal fade" id="Unit" role="dialog">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Tambah Unit Barang</h4>
              <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
              <div class="fetched-data"></div>
  ...
  <script type="text/javascript">
            ...
            $(document).ready(
                function(){
                $('#Unit').on('show.bs.modal', function (e) {
                    var rowid = $(e.relatedTarget).data('id');
                    $.ajax({
                        type : 'post',
                        url : 'unit.php',
    ...
    function hapusBarang(id){
      alertify.confirm('Perhatian', 'Anda Yakin Akan Menghapus '+id, function(){ window.location.assign('hapus-barang.php?id='+id) }
