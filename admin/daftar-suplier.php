...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Daftar Supplier Barang</h1>
            <button class="d-none d-sm-inline-block btn btn-sm btn-primary" data-toggle="modal" data-target="#modalTambahSuplier">Tambah Suplier Barang</button>
          </div>
          <!-- Content Row -->
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Tambah Suplier Barang</h4>
  ...
  <script type="text/javascript">
            ...
            $(document).ready(
                function(){
                $('#modalTambahSuplier').on('show.bs.modal', function (e) {
                    var tambah = 'tambah';
                    $.ajax({
                        type : 'post',
                        url : 'tambahSuplier.php',
                        data :  'tambah='+ tambah,
