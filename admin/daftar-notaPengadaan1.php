...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <table class="table table-bordered table-hover" id="datatable-buttons" width="100%" cellspacing="0">
                      ...
                      <tbody>
                        ...
                        while ($res=mysqli_fetch_array($sql)) {
                          switch ($res['status']) {
                            case '2':
                              $status='<span class="badge badge-danger">Tidak Acc</span>';
                              break;
                            case '1':
                              $status='<span class="badge badge-success">Dipesan</span>';
                              break;
                            default:
                              $status='<span class="badge badge-secondary">Menunggu ACC</span>';
                              break;
                          }
                        ?>
                        <tr>
                          ...
                          <td><?=$res['no_hp'];?></td>
                          <td><?=$status;?></td>
                          <td> <a href="notaPengadaan.php?menu=notaPengadaan&id=<?=$res['no_pengadaan'];?>"> <button type="button" class="btn btn-sm btn-primary">Detail</button></a></td>
                          <td>
                          <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modalKet" data-id="<?=$res['id_pengadaan'];?>">Keterangan</button></br></br>
                          <a class="btn btn-sm btn-success" href="pesan.php?no_pengadaan=<?php echo $res['no_pengadaan']; ?>" >Acc</a></br></br>
                          <a class="btn btn-sm btn-danger" href="batal.php?no_pengadaan=<?php echo $res['no_pengadaan']; ?>" >Tidak Acc</a></td>
                        </tr>
                        <?php
                        $i++;
                        }
      ...
      <!-- End of Main Content -->
      <div class="modal fade" id="modalKet" role="dialog">
  ...
  <script type="text/javascript">
            $(document).ready(function() {
                ...
                $(document).ready(
                function(){
                $('#modalKet').on('show.bs.modal', function (e) {
