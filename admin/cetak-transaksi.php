	...
	<body>
      ...
      <tbody>
          <?php
            ...
            $qy = mysqli_query($koneksi,"SELECT * FROM tb_transaksi WHERE tanggal BETWEEN '$dt1' AND '$dt2' ");
            ...
            <tr>
              <?php echo $dt1?>
                          ...
                          <td width="16%"><?=$res['tgl_pesan'];?></td>
                          <td width="16%"><?=$res['tgl_kembali'];?></td>
        ...
        <tr>
          ...
          <th align="left">Rp.<?php echo number_format($total);?> </th>
        </tr>
      </tfoot>
        </table>
	</body>
